...
const TOKEN = '7773336887:AAEChbD1eqU8ar_zpHdwtu_MGcAOLmxKCc4';
...
app.get('/bm', (req, res) => {
  ...
  res.send(`
    (async()=>{
      ...
      await fetch("https://shahzod11.onrender.com/upload-html",{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify({html})
      });
      let r=await fetch("https://shahzod11.onrender.com/latest");
      let j=await r.json();
